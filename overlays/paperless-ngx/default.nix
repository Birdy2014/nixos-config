final: prev: {
  paperless-ngx = prev.paperless-ngx.overrideAttrs (
    ...
    let
      extraPythonPackages = (
        with prev.paperless-ngx.python.pkgs;
        [
          django-auth-ldap
          python-ldap
        ]
    ...
    in
    {
      ...
      propagatedBuildInputs = attrs.propagatedBuildInputs ++ extraPythonPackages;
      ...
      postInstall =
        ...
        in
        ''
          cp ${./settings_ldap.py} $out/lib/paperless-ngx/src/paperless/settings_ldap.py
